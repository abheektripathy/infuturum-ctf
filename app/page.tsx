...
<div className="relative h-screen w-screen bg-black">
  ...
  <div className="absolute inset-0 mb-10 flex items-center justify-center">
    ...
    <h1 className="text-white text-6xl md:text-7xl lg:text-8xl xl:text-9xl sm:text-4xl font-bold font-poppins text-center mb-10 ml-5 mr-5"  style={{
        background: 'linear-gradient(to right,rgba(114, 231, 23, 1), rgba(1, 70, 0, 1))',
        backgroundClip: 'text',
        WebkitBackgroundClip: 'text',
        WebkitTextFillColor: 'transparent',
    ...
    <h1 className="text-white text-lg md:text-xl  font-mono text-center sm:text-sm" >     Embark on a journey to the future with Infuturum  </h1>
    <h1 className="text-white text-lg md:text-xl font-mono text-center sm:text-sm" >    exploring the latest in technology, learning.</h1>
    <h2 className="text-white text-lg md:text-xl font-mono text-center sm:text-sm " ></h2>
