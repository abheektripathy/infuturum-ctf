...
<div className="relative h-screen w-screen bg-black">
  ...
  <div className="absolute inset-0 mb-10 flex items-center justify-center">
    ...
    <h1 className="text-white text-lg md:text-xl font-mono text-center " >      Congralutions, for making it this far 🎉     </h1>
    <h2 className="text-white text-lg md:text-xl font-mono text-center " >ℹ️ For the final problem, start by pulling this image</h2>
