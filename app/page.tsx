...
<div className="relative h-screen w-screen bg-black">
  ...
  <div className="absolute inset-0 mb-10 flex items-center justify-center">
    ...
    <h1 className="text-white text-lg md:text-xl font-mono text-center " >     Embark on a journey to the future with Infuturum  </h1>
    <h1 className="text-white text-lg md:text-xl font-mono text-center " >    exploring the latest in technology, learning.</h1>
    <h2 className="text-white text-lg md:text-xl font-mono text-center " ></h2>
